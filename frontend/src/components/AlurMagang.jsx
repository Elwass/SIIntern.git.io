  ...
  return (
    <section className="py-12 bg-white">
      <div className="max-w-5xl mx-auto px-4 mt-10 relative">
        ...
        <div className="hidden md:block absolute left-1/2 top-20 bottom-0 w-[2px] bg-gray-200 h-full opacity-70 -translate-x-1/2" />
          ...
          {steps.map((step, i) => {
            ...
            return (
              <div key={step.title} className="relative flex items-center justify-between mb-16">
                <div className="absolute left-4 md:left-1/2 md:-translate-x-1/2 w-4 h-4 bg-red-500 rounded-full z-10 shadow-[0_0_0_6px_rgba(239,68,68,0.15)]" />
