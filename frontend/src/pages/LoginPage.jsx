    ...
    <div className="min-h-screen bg-slate-50">
      <div className="grid min-h-screen grid-cols-1 lg:grid-cols-2">
        ...
        <div className="relative hidden overflow-hidden lg:block">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-slate-50 via-white/30 to-transparent" />
          <div className="pointer-events-none absolute left-0 top-0 h-full w-24 bg-gradient-to-r from-slate-50/90 to-transparent" />
        </div>
      </div>
    </div>
  )
